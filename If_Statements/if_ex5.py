...
day = day.removeprefix("0")  # remove only the prefix is starting from 0


if month == "01":
    print(f"January {day}, {year}")    # f instead of writing ("January", day+", "+year) this is for formating
elif month == "02":
...
print("Enter a date in format of month/day/year")
date = input()
