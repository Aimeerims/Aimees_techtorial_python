...
# If the user gives 21 -> your number is within 2 a multiple 10
# IF the user gives 43 -> your number is within a multiple 10
# IF the user gives 39 -> your number is within 2 a multiple 10
...
if remainder >= 8 or remainder<=2:
    print("your number is within 2 a multiple 10")
else: 
    print("your number didnt match the expected requirement")
