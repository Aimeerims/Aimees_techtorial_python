...
# if the condition below in True driver is in IN
# If the driver is not in Indiana the condition bellow will be False
is_in_IN = state_in =="IN"
# print( is_in_IN)  
# print(not is_in_IN)  --> True

ten_persent_up_IN = speed_limit_IN + speed_limit_IN*10/100
ten_persent_up_others = speed_limit_others+speed_limit_others*10/100

if is_in_IN and speed_of_driver <= speed_limit_IN:
    print("You are driving safe!")
elif is_in_IN and speed_of_driver>speed_limit_IN and speed_of_driver <= ten_persent_up_IN:
    print("Yellow warning!")
elif is_in_IN and speed_of_driver > ten_persent_up_IN:
    print("$150 and 5 points")
elif not is_in_IN and speed_of_driver<=speed_limit_others:
    print("You are driving safe!")
elif not is_in_IN and speed_of_driver>speed_limit_others and speed_of_driver<ten_persent_up_others:
    print("Citation")
elif not is_in_IN and speed_of_driver>ten_persent_up_others:
    print("$100")
